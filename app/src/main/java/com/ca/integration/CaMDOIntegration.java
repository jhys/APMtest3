...
public class CaMDOIntegration {
    ...
    public static final int CAMAA_SCREENSHOT_QUALITY_HIGH = 90;
    public static final int CAMAA_SCREENSHOT_QUALITY_MEDIUM = 50;
    public static final int CAMAA_SCREENSHOT_QUALITY_LOW = 20;
     ...
     */
    public static void sendScreenShot(String screenName,int quality){
    }
    ...
    /**
     * When a page or view is fully loaded take screenshot.
     * @param screenName
     * @param screenLoadTime
     */
    public static void viewLoaded(String screenName,int screenLoadTime) {
